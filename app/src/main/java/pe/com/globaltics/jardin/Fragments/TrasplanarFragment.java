 ...
 */
public class TrasplanarFragment extends Fragment  implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void Llenar() {
        ...
        new LlenarPlantas(getActivity(),urla,accion,codigo,5,rv,swipeRefreshLayout).execute();
    }
}
